...
def chunkify_pytree(tree: PyTree, target_path: str) -> ChunkifiedPytreePath:
    """
    ...
    Returns:
        ChunkifiedPytreePath: A path to the chunked files.
    ...
    return ChunkifiedPytreePath(path=str(pathlib.Path(target_path)))
