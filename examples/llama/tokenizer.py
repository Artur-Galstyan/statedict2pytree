...
# terms of the Llama 3 Community License Agreement.
...
class Tokenizer:
    ...
    def encode(
        ...
        *,
        ...
        Args:
            ...
            allowed_tokens ("all"|set[str]):
            disallowed_tokens ("all"|set[str]):
    ...
    def decode(self, t: Sequence[int]) -> str:
        ...
        # Tiktoken doesn't do anything list-related with the sequence.
